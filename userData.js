  ...
  OMIKUJI: {
    ...
    janken: [
      ...
      { 'ran': 2, 'chara': 'ゆっくり魔理沙', 'message': [['じゃんけんぽん!', 0], ['俺の勝ち!マリサ キリサメの心なんて読めるわけがない、そう思ってないですか。あきらめへん人だけに見える景色があるはずです。', 4500]], 'img': [['!janken_1', 500], ['!marisa02', 0], ['!janken_lose', 2000], ['!marisa12', 4500]] },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!いい勝負でしたね!でも結果が伴わないと、全く意味がありません。', 4500]
        ],
        img: [
          ['!janken_1', 500],
          ['!reimu02', 0],
...

      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!ちゃんと分析してます?じっくり結果に向き合ってください。', 4500]
        ],
        img: [
          ['!janken_1', 500],
          ['!marisa02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!何事も準備がすべて。それを怠っている事がバレてますよ。', 4500]
        ],
        img: [
          ['!janken_1', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!ここは練習ではありません。全身全霊で俺と向き合ってください。', 4500]
        ],
        img: [
          ['!janken_1', 500],
          ['!marisa02', 0],
...

      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!たかがじゃんけん、そう思ってないですか？それやったら明日も、俺が勝ちますよ。', 4500]
        ],
        img: [
          ['!janken_2', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!ウラのウラのウラまで読む訓練をしてくださいね。どこまで読もうとするかで結果が変わってきます。', 4500]
        ],
        img: [
          ['!janken_2', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!自信を持って勝負にしっかりと向き合える、そう思えるまで、準備してください。', 4500]
        ],
        img: [
          ['!janken_2', 500],
          ['!marisa02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!ただの運やと思ってませんか?運も実力のうち!聞いたことありますよね?', 4500]
        ],
        img: [
          ['!janken_2', 500],
          ['!marisa02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!あなたの考えてる事ぐらい、俺にはお見通しです。', 4500]
        ],
        img: [
          ['!janken_2', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!その程度の、気持ちで勝てるとでも思ったんですか?ちゃんと練習してきてください。', 4500]
        ],
        img: [
          ['!janken_2', 500],
          ['!marisa02', 0],
...

      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!なんで負けたか、明日まで考えといてください。そしたら何かが見えてくるはずです。', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!どんな事でも絶対に勝つんや!というメンタリティーが大事ですよ。', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!複雑に考えてないですか?答えはシンプルです。マリサ キリサメの心を読む、それだけです。', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!marisa02', 0],
...

      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!動揺してませんか?運が大事な時こそ集中力が物を言いますよ!', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!正確にはじゃんけんを味方につけた俺の勝ち!', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!marisa02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!それで勝てると思ってるんやったら、俺がずっと勝ちますよ!', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の勝ち!1年間何やってたんですか？この結果はじゃんけんに対する意識の差です。', 4500]
        ],
        img: [
          ['!janken_3', 500],
          ['!marisa02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の負け!やるやん!でも、今度は絶対、俺が勝つから!また明日やろう!', 4500]
        ],
        img: [
          ['!janken_4', 500],
          ['!reimu02', 0],
      ...
      },
      {
        ...
        message: [
          ['じゃんけんぽん!', 0],
          ['俺の負け!やるやん。今日は負けを認めます。ただ、勝ち逃げは許しませんよ。', 4500]
        ],
        img: [
          ['!janken_4', 500],
          ['!reimu02', 0],
